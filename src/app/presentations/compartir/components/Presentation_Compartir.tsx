...
import { WhereSlide } from "../slides/WhereSlide";
import { OpenSlide } from "../slides/OpenSlide";
import { ReproducibleSlide } from "../slides/ReproducibleSlide";
...
const slideComponents: Record<string, React.ComponentType> = {
  ...
  where: WhereSlide,
  open: OpenSlide,
  reproducible: ReproducibleSlide,
...
export function Presentation() {
  ...
  const currentAudioPath = getAudioPath("compartir", meta);
  const hasSlideAudio = hasAudio("compartir", meta);
